...
#     #====================================
#     #Prospecção de Faturamento(calculo)
#     #===================================
...
#     # Filtrar dias úteis
#     dias_uteis = datas_mes[datas_mes.weekday < 5]  # 0=segunda, ..., 4=sexta

#     # Dias úteis passados e restantes
#     dias_uteis_passados = sum(dias_uteis <= hoje)
#     dias_uteis_restantes = sum(dias_uteis > hoje)

#     # Média diária útil
#     media_diaria_uteis = total_vendido / dias_uteis_passados
...
#     col4.metric("Faturamento Projetado", f"R${faturamento_projetado:,.0f}")
#     col5.metric("Meta Atingida", f"{percentual_meta:.0f}%", delta=f"R$ {total_vendido:,.0f} / R$ {meta:,.0f}")
